...
export const DOF_DEFAULT_NEAR_BLUR = 15; // fully blurred at/below this distance
export const DOF_DEFAULT_NEAR_CLEAR = 16; // fully sharp from here...
export const DOF_DEFAULT_FAR_CLEAR = 21.5; // ...to here
export const DOF_DEFAULT_FAR_BLUR = 27; // fully blurred at/beyond this distance
export const DOF_SLIDER_MAX = 60; // range-input upper bound, metres
export const DOF_MAX_BLUR_LOD = 4; // mip level sampled at full blur
